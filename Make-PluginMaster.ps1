...
$dlTemplateInstall = "https://raw.githubusercontent.com/Blackwolf1337/DalamudPlugins/api6/{0}/{1}/latest.zip"
$dlTemplateUpdate = "https://raw.githubusercontent.com/Blackwolf1337/DalamudPlugins/api6/{0}/{1}/latest.zip"
